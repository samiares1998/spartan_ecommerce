  ...
  <x-organisms.navbar :path="$shop->path"/>
    <div class="container py-y d-flex flex-column align-items-center gap-3">
      ...
      <div class="text-center">
        ...
        <p>You can always track your orders in the <a href="{{ route('clientCheckOrder') }}"><u>Consultar Orden</u></a>, please keep and don't forget this code for check status order.</p>
      </div>
