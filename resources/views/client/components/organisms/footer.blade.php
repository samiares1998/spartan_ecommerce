    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-6 ">
          <h6>Compañia</h6>
          <a href="/about" class="text-decoration-none"><p>Acerca de nosotros</p></a>
          <a href="/products" class="text-decoration-none"><p>Productos</p></a>
          <a href="/about#address" class="text-decoration-none text-dark"><p>Direccion</p></a>
        </div>
        <div class="col-lg-3 col-md-3 col-6 ">
          <h6>Soporte</h6>
          <!--<a href="/about#faq" class="text-decoration-none text-dark"><p>FAQ</p></a>-->
          <a href="/about#shippingandreturns" class="text-decoration-none text-dark"><p>Envíos y devoluciones</p></a>
          <a href="/about#warranty" class="text-decoration-none text-dark"><p>Garantia</p></a>
        </div>
          ...
          <div class="d-lg-block d-md-block d-none">
            <div class="row">
              <div class="col-3">
               ...
               <a href="https://www.instagram.com/spartan_tienda_fit/">
                <p class="d-flex align-items-center">  <img src="{{ asset('client/img/icon-instagram.png') }}" alt="" class="img-fluid me-2">  @spartan_tienda_fit</p>
